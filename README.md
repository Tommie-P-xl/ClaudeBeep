...
<p align="center">
  <img src="https://img.shields.io/badge/version-v2.3.3-blue" alt="Version">
...
Download the latest `ClaudeBeep-Setup-*.exe` from [Releases](https://github.com/Tommie-P-xl/ClaudeBeep/releases/tag/v2.3.3) and run the installer.
